...
Nós queremos provar o teorema \ref{teo: parity_lb}. Para isso, nós provaremos que se fizermos $p = \frac{1}{10w}(\frac{1}{10l})^{d - 2}$, onde $w$ é o fan-in no nível mais baixo do circuito $C$ e $l = \log(2\lvert C \rvert /\varepsilon)$
