...
Se $x$ é má então $Tribes_{n}(x) = 1$ se e somente se pelo menos uma das $\frac{9}{10}s$ tribos restantes é unanimamente 1. Isso acontece com probabilidade $1 - (1 - 2^{-w})^{\frac{9}{10}s}$, mas temos que:

\begin{equation*}
    1/2 \leq (1 - 2^{-w})^{\frac{9}{10}s} \leq 2^{-\frac{9}{10}} < 0,55
\end{equation*}

Para $w$ suficientemente grande. Ou seja, condicionando em nenhuma das primeiros $\frac{1}{10}s$ tribos serem unanimamente 1, o melhor que $A$ pode fazer é adivinhar que $\Tribes_{n}(x) = 0$ e ainda assim $A$ não poderá fazer melhor do que acertar numa fração maior do que 0,55 das vezes. Então:
