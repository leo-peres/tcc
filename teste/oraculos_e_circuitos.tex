...
\begin{teo} \label{sigma2_vs_np_r}
	$\Pr_{A \sim \binalph^{*}}[\NP^{A} \neq \Sigma_{2}^{p, A}] = 1$.
\end{teo}

E o teorema \ref{sigma2_vs_np_r} segue do seguinte limite inferior para uma fórmula FNC que aproxima uma variação da função $\Tribes$.
