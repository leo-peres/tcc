...
Agora nós queremos mostrar que funções lineares são testáveis com apenas 3 consultas. Antes disto precisamos fazer algumas definições que irá facilitar a prova.
...
Seja $\varepsilon > 0$. Considere as seguintes condições que uma função $f: \mathbb{F}_{2}^{n} \to \{-1, 1\}$ pode satisfazer:

\begin{enumerate}

	\item  Se $x, y \sim \mathbb{F}_{2}^{n}$ são uniforme e independentes então $\Pr[f(x)f(y) = f(x + y)] > 1 - \varepsilon$.
	
	\item Existe um $S \subseteq [n]$ tal que $\Pr_{x \sim \mathbb{F}_{2}^{n}}[f(x) = \chi_{S}(x)] > 1 - \varepsilon/3$.
	
	\item Existe um $S \subseteq [n]$ tal que $\widehat{f}(S) > 1 - \varepsilon/3$.

\end{enumerate}

Então temos que (1), (2) e (3) são todas equivalentes.

\end{prop}

\begin{proof}

Que $(1) \Rightarrow (2)$ (ou $(1) \Rightarrow (3)$) é a parte não trivial então vamos deixar por último.
...
\begin{itemize}
	...
	\item $(2) \Rightarrow (3)$:
		...
		\begin{IEEEeqnarray*} {rCl}
			1 - \varepsilon/3 & < & \Pr_{x \sim \mathbb{F}_{2}^{n}}[f(x) = \chi_{S}(x)] \\
			                           & = & \E_{x \sim \mathbb{F}_{2}^{n}}[f(x)\chi_{S}(x)] \\
			                           & = & \widehat{f}(S).
		\end{IEEEeqnarray*}
	...
	\item $(3) \Rightarrow (1)$:
		...
		\begin{IEEEeqnarray*} {rCl}
			1 - \varepsilon/3 & < & \widehat{f}(S) \\
					      & = & \E_{x \sim \mathbb{F}_{2}^{n}}[f(x)\chi_{S}(x)] \\
					      & = & \Pr_{x \sim \mathbb{F}_{2}^{n}}[f(x) = \chi_{S}(x)]
		\end{IEEEeqnarray*}
		
		Então se $x, y \in \mathbb{F}_{2}^{n}$ são uniformes e independentes, temos que $\Pr[f(x) = \chi_{S}(x) \land f(y) = \chi_{S}(y) \land f(x + y) = \chi_{S}(x + y)] > 1 - \varepsilon$, o que implica em $\Pr[f(x)f(y) = f(x + y)] > 1 - \varepsilon$, pois se $f(x) = \chi_{S}(x)$, $f(y) = \chi_{S}(y)$ e $f(x + y) = \chi_{S}(x + y)$ então devemos ter $f(x)f(y) = \chi_{S}(x)\chi_{S}(y) = \chi_{S}(x + y) = f(x + y)$.
		...
		E como já vimos que $\sum_{S \subseteq [n]}\widehat{f}(S)^{3} > 1 - 2\varepsilon$, podemos concluir que $\widehat{f}(A) > 1 - 2\varepsilon$ e portanto
		
		\begin{IEEEeqnarray*} {rCl}
			\Pr_{x \sim \mathbb{F}_{2}^{n}}[f(x)  = \chi_{A}(x)] & = & \E_{x \sim \mathbb{F}_{2}^{n}}[\frac{1}{2} + \frac{1}{2}f(x)\chi_{A}(x)] \\
			                                                                                       & = & \frac{1}{2} + \frac{1}{2}\E_{x \sim \mathbb{F}_{2}^{n}}[f(x)\chi_{A}(x)] \\
			                                                                                       & = & \frac{1}{2} + \frac{1}{2}\widehat{f}(A) \\
			                                                                                       & > & \frac{1}{2} + \frac{1}{2}(1 - 2\varepsilon) \\
			                                                                                       & = & 1 - \varepsilon
		\end{IEEEeqnarray*}
