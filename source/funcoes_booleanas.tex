...
\begin{IEEEeqnarray*} {rCl}
	\E[d^{4}] + 6\sqrt{\E[e^{4}]}\sqrt{\E[e^{4}]} + \E[e^{4}] & \leq & 9^{k - 1}\E[d^{2}]^{2} + 6\sqrt{9^{k - 1}\E[d^{2}]^{2}}\sqrt{9^{k}\E[e^{2}]^{2}} + 9^{k}\E[e^{2}]^{2} \\
...
\begin{IEEEeqnarray*}{rCl}
	\Pr_{x \sim \pmonen}\Big[\lvert f(X) - \mu \rvert > \frac{1}{2}\sigma\Big] & = & \Pr_{x \sim \pmonen}\Big[\sigma\lvert g \rvert > \frac{1}{2}\sigma\Big] \\
	                                                                                                            & = & \Pr_{x \sim \pmonen}\Big[\lvert g \rvert > \frac{1}{2}\lVert g \rVert_{2}\Big] \\
