...
Seja $F$ uma fórmula na FNC (ou FND) com largura $w$, $s \geq 1$ e $\rho_{1} \leftarrow P_{1}$, então
...
Seja $F$ uma fórmula na FNC (ou FND) com largura $w$, $s \geq 1$ e $\rho_{1} \leftarrow P_{i}$, para algum $i > 1$, então
