...
\begin{IEEEeqnarray*} {rCl}
	\Pr[\textbf{x}_{a^{\prime}} = 1] & = & 1 - \frac{t}{1 - (1 - t)^{\lvert S_{a} \rvert}} + \frac{t(1 - t)^{\lvert S_{a} \rvert}}{1 - (1 - t)^{\lvert S_{a} \rvert}} \\
				        & = & 1 - \frac{t}{1 - (1 - t)^{\lvert S_{a} \rvert}}\big(1 - (1 - t)^{\lvert S_{a} \rvert} \big) \\
				        & = & 1 - t.
\end{IEEEeqnarray*}
