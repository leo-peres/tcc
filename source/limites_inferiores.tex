...
\begin{enumerate}
	...
	\begin{IEEEeqnarray*} {rCl}
		\sum_{\rho_{1} \in \mathcal{B}} \kappa^{s} \Pr_{\boldsymbol{\rho} \leftarrow P_{1}}[\boldsymbol{\rho} = \rho_{1}^{\prime}] & \leq & (\kappa 2^{r + 4}r)^{s}\sum_{\rho_{1}^{\prime} \in \mathcal{C}} \Pr_{\boldsymbol{\rho} \leftarrow P_{1}}[\boldsymbol{\rho} = \rho_{1}^{\prime}] \\
																					    & \leq & (\kappa 2^{r + 4}r)^{s}.  
	\end{IEEEeqnarray*}
