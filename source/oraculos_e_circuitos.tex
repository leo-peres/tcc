...
\begin{IEEEeqnarray*} {rCl}
    \Pr[g_{z^{*}}^{\prime}(\boldsymbol{y}) \neq \orr_{2^{b}}(\boldsymbol{y})] & \geq & \Big\lvert \Pr[g_{z^{*}}^{\prime}(\boldsymbol{y}) = 0] - \Pr[\orr_{2^{b}}(\boldsymbol{y}) = 0] \Big\rvert \\
...
\begin{IEEEeqnarray*} {rCl}
    \Pr_{\boldsymbol{x}_{1}, \boldsymbol{x}_{2} \sim \binalph^{m}}[g(\boldsymbol{x}_{1}, \boldsymbol{x}_{2}) \neq F_{m}(\boldsymbol{x}_{1}, \boldsymbol{x}_{2})] & \geq & \Pr_{\boldsymbol{x}_{1}, \boldsymbol{x}_{2} \sim \binalph^{m}}[g(\boldsymbol{x}_{1}, \boldsymbol{x}_{2}) \neq F_{m}(\boldsymbol{x}_{1}, \boldsymbol{x}_{2}) \land \Tribes_{b, 2^{b}}^{\dagger}(\boldsymbol{x}_{2}) = 0] \\
                                                                                                                                                                 & =    & \Pr_{\boldsymbol{x}_{1}, \boldsymbol{x}_{2} \sim \binalph^{m}} [g(\boldsymbol{x}_{1}, \boldsymbol{x}_{2}) \neq \Tribes_{b, 2^{b}}(\boldsymbol{x}_{1}) \land \Tribes_{b, 2^{b}}^{\dagger}(\boldsymbol{x}_{2}) = 0].
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*} {rCl}
    \Pr[g(\boldsymbol{x}_{1}, \boldsymbol{x}_{2}) \neq \Tribes_{b, 2^{b}}(\boldsymbol{x}_{1}) \lvert \Tribes_{b, 2^{b}}^{\dagger}(\boldsymbol{x}_{2}) = 0] & =    & 2^{-m}\sum_{x_{2}^{*} \in \Tribes_{b, 2^{b}}^{\dagger -1}(0)} \Pr[g_{x_{2}^{*}}(\boldsymbol{x}_{1}) \neq \Tribes_{b, 2^{b}}(\boldsymbol{x}_{1})] \\
                                                                                                       & \geq & 1/3.
\end{IEEEeqnarray*}
...
\begin{teo} [O'Donnell, Wimmer] \label{odonnel_wimmer_size}
